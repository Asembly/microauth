...
public class KafkaConfig {
    ...
    @Bean
    public NewTopic signInResponses()
    {
        return TopicBuilder.name("signin-responses").build();
    }
    @Bean
    public NewTopic signUpResponses()
    {
        return TopicBuilder.name("signup-responses").build();
    }
